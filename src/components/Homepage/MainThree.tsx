...
const MainThree = (props: Props) => {
	return (
		<div className="container rounded-xl border-[3px] border-solid border-[#93f] items-center max-w-6xl mx-auto" style={{padding:"2em 5% 0.75em 9%",margin:"0em auto 4em auto"}}>
