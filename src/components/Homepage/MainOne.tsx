	...
	return (
		<div className='container pt-20 relative max-w-6xl mx-auto'>
			<div className='flex flex-wrap relative'>{/* className='row' */}
				...
				{/* !isLoggedIn && */
					<div className="md:flex md:flex-shrink-0 lg:w-1/2 w-full max-w-full flex-shrink-0 grow-0 basis-auto lg:justify-start justify-center lg:pl-3 pl-0">{/* className="col-md-6 col-12" */}
