	...
	return (
		<div className="container mx-auto px-[calc(1.5rem*0.5)]">
			<div className="flex flex-wrap mt-10 mx-5 py-20">
				...
				<div className="lg:w-1/12 flex-shrink-0 grow-0 basis-auto w-full"></div>

				<div className="lg:w-1/2 flex-shrink-0 grow-0 basis-auto w-full relative">
					...
					<div className="block w-full lg:ml-4 mr-0 pr-0">
						{p1Visible &&
							<div className="animate-[opacity_.15s_linear] rounded-[15px] bg-[#2f2f2f] p-[30px] relative">
