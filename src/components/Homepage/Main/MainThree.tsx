...
const MainThree = (props: Props) => {
	return (
		<div className="container mx-auto [@media(max-width:640px)]:!max-w-full px-[calc(1.5rem*0.5)] rounded-xl border-[3px] border-solid border-[#93f] items-center" style={{padding:"2em 5% 0.75em 9%",margin:"0em auto 4em auto"}}>
