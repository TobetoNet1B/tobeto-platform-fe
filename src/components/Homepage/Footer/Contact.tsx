          ...
          <div className="flex-grow-0 flex-shrink-0 basis-auto w-full lg:px-2 lg:box-border lg:flex-grow-0 lg:flex-shrink-0 lg:basis-auto lg:w-[50%] order-first relative">
            <div className="relative py-12 px-8 bg-white shadow-[0_20px_80px_-16px_rgba(28,25,23,.04)] rounded-2xl text-center">
              <form  action="#" data-hs-cf-bound="true">
                ...
                <input name="name" value={name} onChange={handleChange} className="block w-full py-4 px-6 text-sm font-normal border-[1px] border-solid border-[#e7e5e4] rounded-md appearance-none !mb-6 input" type="text" placeholder="Adınız Soyadınız"/>
                <input name="email" value={email} onChange={handleChange} className="block w-full py-4 px-6 text-sm font-normal border-[1px] border-solid border-[#e7e5e4] rounded-md appearance-none !mb-6 input" type="email" placeholder="E-Mail"/>
                <textarea name="message" value={message} onChange={handleChange} className="block w-full py-4 px-6 text-sm font-normal border-[1px] border-solid border-[#e7e5e4] rounded-md appearance-none !mb-6 textarea" cols={30} rows={10} placeholder="Mesajınız" defaultValue={""}/>
