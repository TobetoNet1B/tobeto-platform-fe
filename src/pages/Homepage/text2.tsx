...
export default function text2() {
    ...
    return (
        <div className="">
                                ...
                                <div role="tablist" className="relative flex flex-none items-center mx-0 mt-0 mb-4 before:bottom-0 before:absolute before:right-0 before:left-0 before:border before:border-solid before:border-[#f0f0f0] before:content-['']">{/*className="ant-tabs-nav" */}
                                    <div className="relative flex flex-auto self-stretch overflow-hidden whitespace-nowrap transform translate-x-0 translate-y-0 before:absolute before:z-[1] before:opacity-0 before:transition-opacity before:duration-[300ms] before:content-[''] before:pointer-events-none before:left-0 before:shadow-[10px_0_8px_-8px_rgba(0, 0, 0, 0.08)] before:top-0 before:bottom-0 before:w-8 after:absolute after:z-[1] after:opacity-0 after:transition-opacity after:duration-[300ms] after:content-[''] after:pointer-events-none after:right-0 after:shadow-[10px_0_8px_-8px_rgba(0, 0, 0, 0.08)] after:top-0 after:bottom-0 after:w-8">{/*className="ant-tabs-nav-wrap" */}
                                        <div className="relative flex transition-opacity duration-[300ms]" style={{ transform: "translate(0px, 0px)" }}>{/*className="ant-tabs-nav-list" */}
                                            <div data-node-key="content" className="relative inline-flex items-center py-3 px-0 text-sm bg-transparent border-0 outline-none cursor-pointer  text-black">{/*className="ant-tabs-tab ant-tabs-tab-active" */}
                                                <div role="tab" aria-selected="true" className="text-black transition-none font-medium outline-none" tabIndex={0} id="rc-tabs-0-tab-content" aria-controls="rc-tabs-0-panel-content">{/*className="ant-tabs-tab-btn" */}
                                                    <div className="relative cursor-pointer">{/*className="tabs-nav " */}
                                                        <span className="text-lg">İçerik</span>{/*className="tabs-nav-title" */}
                                                    </div>
                                                </div>
                                            </div>
                                            <div data-node-key="about" className="text-[#7f7f7f] my-0 mr-0 ml-8 relative inline-flex items-center py-3 px-0 text-sm bg-transparent border-0 outline-none cursor-pointer">{/*className="ant-tabs-tab" */}
                                                <div role="tab" aria-selected="false" className="text-[#7f7f7f] transition-none font-medium outline-none" tabIndex={0} id="rc-tabs-0-tab-about" aria-controls="rc-tabs-0-panel-about">{/*className="ant-tabs-tab-btn" */}
                                                    <div className="relative cursor-pointer">{/*className="tabs-nav " */}
                                                        <span className="text-lg">Hakkında</span>{/*className="tabs-nav-title" */}
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="!bg-black bottom-0 h-0.5 absolute pointer-events-none" style={{ left: 0, width: 48 }} />{/*className="ant-tabs-ink-bar" */}
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="!px-2 col-lg-5 col-md-5 col-sm-12 w-full flex-grow-0 flex-shrink-0 basis-full">{/*className="col-lg-5 col-md-5 col-sm-12 col-xs-12" */}
                                                        <div className="activity-content-menu LXP-Collapse">{/*className="activity-content-menu LXP-Collapse" */}
                                                            <div className="max-h-[600px]" style={{ position: "relative", width: "100%", height: 9405 }}>{/*className="ScrollbarsCustom trackYVisible" */}
                                                                ...
                                                                <div className="bg-transparent rounded-[10px] w-1 top-0 h-full" style={{ position: "absolute", overflow: "hidden", borderRadius: 4, background: "rgba(0, 0, 0, 0.1)", userSelect: "none", width: 10, height: "calc(100% - 20px)", top: 10, right: 0 }}>{/*className="ScrollbarsCustom-Track ScrollbarsCustom-TrackY" */}
                                                                    <div className="bg-[#ededed] relative  ScrollbarsCustom-ThumbY"
                                                                ...
                                                                <div className="bg-transparent rounded-[10px] w-full h-3 left-0" style={{ position: "absolute", overflow: "hidden", borderRadius: 4, background: "rgba(0, 0, 0, 0.1)", userSelect: "none", height: 10, width: "calc(100% - 20px)", bottom: 0, left: 10, display: "none" }}>{/*className="ScrollbarsCustom-Track ScrollbarsCustom-TrackX" */}
                                                                    <div className="relative bg-[#808080] ScrollbarsCustom-ThumbX" style={{ touchAction: "none", cursor: "pointer", borderRadius: 4, background: "rgba(0, 0, 0, 0.4)", height: "100%", width: 0, display: "none" }} />{/*className="ScrollbarsCustom-Thumb ScrollbarsCustom-ThumbX" */}
                                                                </div>
                                                            </div>
            ...
            <div className="absolute !top-[50%] !right-[50%] !left-0 !bottom-0 hidden" style={{ position: "absolute", inset: "0px 10px 0px 0px", overflow: "hidden" }}>{/*className="ScrollbarsCustom-Wrapper" */}
                <div className="" style={{ position: "absolute", inset: 0, overflow: "hidden scroll", marginRight: "-24px" }}>{/*className="ScrollbarsCustom-Scroller" */}
                    <div className="inline-block" style={{ boxSizing: "border-box", display: "table-cell", minWidth: "100%" }}>{/*className="ScrollbarsCustom-Content" */}
                        <div id="directory-collapse-0">
                            <div className="my-0 mx-6 bg-transparent border-0 box-border p-0 text-[#1a1a1a] leading-6 list-none rounded-lg">{/*className="ant-collapse ant-collapse-icon-position-start"> */}
