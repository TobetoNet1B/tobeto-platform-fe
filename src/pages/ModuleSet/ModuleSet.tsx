    ...
    <div className='!overflow-x-hidden !overflow-y-scroll !w-full !h-screen bg-white !font-["Poppins",Helvetica,Arial,sans_serif] !not-italic !text-[14px] !text-black antialiased m-0'>
      ...
      <div id="root">
        <div id="wrapper-content" className="relative mt-0 mx-auto mb-[-80px] min-h-screen h-auto overflow-hidden">{/*className="wrapper without-slide */}
            ...
            <div className="rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.1)] inline-block align-middle w-full h-auto p-5 mb-12">{/*className="page-content activity-detail" */}
              <div className="">{/*className="activity-detail-header" */}
                <div className="!-mx-2 box-border flex flex-row flex-wrap flex-initial">{/*className="row" */}
                  ...
                  <div className="!px-2">{/*className="col-lg-11 col-md-11 col-sm-10 col-xs-12" */}
                    <div className="!-mx-2 box-border flex flex-wrap flex-row flex-initial">{/*className="row" */}
                      <div className="!mx-2 box-border max-w-full flex-grow-0 flex-shrink-0 basis-full">{/*className="col-xs-12" */}
                        <div className="!-mx-2 box-border flex flex-wrap flex-row flex-initial">{/*className="row" */}
                            ...
                            <div className="inline-flex items-center" style={{ gap: 8 }}>{/*className="ant-space ant-space-horizontal ant-space-align-center" */}
                                ...
                                <div className="inline-block !align-bottom !h-8">{/*className="like" */}
                                  <div className="flex cursor-pointer">{/*className="like-area" */}
                                    <span className="w-7 ml-1 text-3xl !text-[#7f7f7f] cursor-pointer">{/*className="like-button liked" */}
                                      <div id="main-content" className="transform translate-y-[-0.4ex] flex items-center justify-center text-center h-9 ">
                                        <div id="sub-content" className="cursor-pointer w-7 pointer-events-none">
                                          <input type="checkbox" id="checkbox" defaultChecked={true} className="hidden box-border p-0 overflow-visible m-0 text-inherit " />
                                          <label id="checkbox-label" htmlFor="checkbox" className="transform -translate-x-5 block font-semibold text-[#000] touch-manipulation" >
                                            ...
                                            >
                                              ...
                                              >
                                                <path
                                                  ...
                                                  className={`fill-none origin-center animate-animateHeart !stroke-[#7f7f7f] stroke-2 `}
                                                  id="heart"
                                                  fill="#AAB8C2"
                                                />
                                                <circle id="main-circ"
                                                  className="transition opacity-100 origin-[29.5px_29.5px] animate-animateCircle"
                                                  fill="#E2264D"
                                                  opacity={0}
                                                  cx="29.5"
                                                  cy="29.5"
                                                ...
                                                <g id="grp7"
                                                  opacity={0}
                                                  transform="translate(7 6)" className="opacity-100 transition-opacity duration-300"
                                                >
                                                  <circle
                                                    id="oval1"
                                                    fill="#9CD8C3"
                                                    cx={2}
                                                    cy={6}
                                                    r={2} className="transform scale-0 -translate-x-8 -translate-y-4 origin-[0_0] "
                                                  />
                                                  <circle
                                                    id="oval2"
                                                    fill="#8CE8C3"
                                                    cx={5}
                                                    cy={2}
                                                    r={2} className="transform scale-0 -translate-x-14 -translate-y-8 origin-[0_0] transition-transform	duration-[1500ms] delay-300"
                                                  />
                                                </g>
                                                <g id="grp6"
                                                  opacity={0}
                                                  transform="translate(0 28)" className="opacity-100 transition-opacity delay-300"
                                                >
                                                  <circle
                                                    id="oval1"
                                                    fill="#CC8EF5"
                                                    cx={2}
                                                    cy={7}
                                                    r={2} className="transform scale-0 -translate-x-14 translate-y-0 origin-[0_0] transition-transform	duration-[500ms] delay-300"
                                                  />
                                                  <circle
                                                    id="oval2"
                                                    fill="#91D2FA"
                                                    cx={3}
                                                    cy={2}
                                                    r={2} className="transform scale-0 -translate-x-16 -translate-y-2 origin-[0_0] transition-transform	duration-[1500ms] delay-300"
                                                  />
                                                </g>
                                                <g id="grp3"
                                                  opacity={0}
                                                  transform="translate(52 28)" className="opacity-100 transition-opacity delay-300"
                                                >
                                                  <circle
                                                    id="oval2"
                                                    fill="#9CD8C3"
                                                  ...
                                                  <circle
                                                    ...
                                                    cx={4}
                                                    cy={2}
                                                    r={2} className="transform scale-0 translate-x-8 translate-y-0 origin-[0_0] transition-transform	duration-[500ms] delay-300"
                                                  />
                                                </g>
                                                <g id="grp2"
                                                  opacity={0}
                                                  transform="translate(44 6)" className="opacity-100 transition-opacity delay-300"
                                                >
                                                  <circle
                                                    id="oval2"
                                                    fill="#CC8EF5"
                                                    cx={5}
                                                    cy={6}
                                                    r={2} className="transform scale-0 translate-x-16 -translate-y-4 origin-[0_0] transition-transform	duration-[1500ms] delay-300"
                                                  />
                                                  <circle
                                                    id="oval1"
                                                    fill="#CC8EF5"
                                                    cx={2}
                                                    cy={2}
                                                    r={2} className="transform scale-0 translate-x-8 -translate-y-4 origin-[0_0] transition-transform	duration-[500ms] delay-300"
                                                  />
                                                </g>
                                                <g id="grp5"
                                                  opacity={0}
                                                  transform="translate(14 50)" className="opacity-100 transition-opacity delay-300"
                                                >
                                                  <circle
                                                    id="oval1"
                                                    fill="#91D2FA"
                                                    cx={6}
                                                    cy={5}
                                                    r={2} className="transform scale-0 translate-x-3 translate-y-5 origin-[0_0] transition-transform	duration-[500ms] delay-300"
                                                  />
                                                  <circle
                                                    id="oval2"
                                                    fill="#91D2FA"
                                                    cx={2}
                                                    cy={2}
                                                    r={2} className="transform scale-0 -translate-x-16 translate-y-8 origin-[0_0] transition-transform	duration-[1500ms] delay-300"
                                                  />
                                                </g>
                                                <g id="grp4"
                                                  opacity={0}
                                                  transform="translate(35 50)" className="opacity-100 transition-opacity delay-300"
                                                >
                                                  <circle
                                                    id="oval1"
                                                    fill="#F48EA7"
                                                  ...
                                                  <circle
                                                    ...
                                                    cx={2}
                                                    cy={2}
                                                    r={2} className="transform scale-0 translate-x-10 translate-y-12 origin-[0_0] transition-transform	duration-[1500ms] delay-300"
                                                  />
                                                </g>
                                                <g id="grp1"
                                                  opacity={0}
                                                  transform="translate(24)" className="opacity-100 transition-all delay-300"
                                                >
                                                  <circle
                                                    id="oval1"
                                                    fill="#9FC7FA"
                                                    cx="2.5"
                                                    cy={3}
                                                    r={2} className="transform scale-0 translate-x-0 -translate-y-8 origin-[0_0] transition-transform	duration-[500ms] delay-300"
                                                  />
                                                  <circle
                                                    id="oval2"
                                                    fill="#9FC7FA"
                                                    cx="7.5"
                                                    cy={2}
                                                    r={2} className="transform scale-0 translate-x-2 -translate-y-12 origin-[0_0] transition-transform	duration-[1500ms] delay-300"
                                                  />
                                                </g>
                                              </g>
                                            </svg>
                                    ...
                                    <span className="text-3xl z-[1] transform translate-x-[0.2em] translate-y-[-0.15ex] mr-4 leading-none !text-[#7f7f7f] cursor-pointer">{/*className="like-text liked" */}
                                      <span className="!text-[#7f7f7f] cursor-pointer">106</span>
                                    </span>
                                  </div>
                                </div>
                              </div>
                              <div className="ant-space-item" style={{}}>
                                <div className="w-9 h-9 inline-block align-middle cursor-pointer">{/*className="activity-favorite" */}
                                  <span className="w-full h-full block !bg-cover !bg-no-repeat !bg-center" style={{ backgroundImage: "url(https://lms.tobeto.com/tobeto/eep/Styles/assets/css/img/icon/learning-experience-platform/remove-favorite.svg)" }} />{/*className="remove-favorite" */}
                                </div>
                              </div>
                      ...
                      <div className="!px-2 box-border max-w-full flex-grow-0 flex-shrink-0 basis-full">{/*className="col-xs-12" */}
                        <div className="text-right w-full sm:w-full md:w-full">{/*className="activity-progress-bar" */}
                          <div className="text-left box-border m-0 p-0 text-slate-900 list-none inline-block relative w-full text-sm me-2 mb-2" role="progressbar">{/*className="ant-progress ant-progress-line ant-progress-status-active ant-progress-show-info ant-progress-default ant-tooltip-open" */}
                            <div className={" -mr-[52] pr-[52] -me-10 pe-10 inline-block"} style={{ width: "100%", height: 3 }}>{/*className="ant-progress-outer" */}
                              <div className="relative inline-block w-full overflow-hidden align-middle text-[#e6e6e6] rounded-[100px]">{/*className="ant-progress-inner" */}
          ...
          <div className="w-[450px] h-auto transition-all duration-500  opacity-100 block visible absolute right-0 top-[77px] left-auto bottom-auto z-[10001]">{/*className="growl-container show top-right" */}
            <div className="growl-item success">
              <Link to={""} id="growl-item-close" className="sg-icon sg-delete close" />
              <span className="icon">
              ...
              <div className="growl-item-content">
                <p>Favorilerden çıkarma işlemin başarıyla gerçekleşti.</p>
              </div>
            </div>
          </div>
