                ...
                <div className="!-mx-2 flex justify-between">
                  <div className="!px-2">
                    ...
                    >
                      ...
                      <span style={{ visibility: 'hidden' }} className="rounded-[5px] inline-block align-middle pt-[6px] pr-1 pb-1 pl-[6px] text-sm mr-[5px] mb-[1px] bg-[#ffd228] border-solid border-[#ffd228] border-[1px] text-[#000]" >
                        YENİ
                      </span>
                      <span style={{ visibility: 'hidden' }} className="rounded-[5px] inline-block align-middle pt-[6px] pr-1 pb-1 pl-[6px] text-sm mr-[5px] mb-[1px] bg-[#549be6] border-solid border-[#549be6] border-[1px] text-[#fff]">
                        GELİŞİM YOLCULUĞU
                      </span>
                      <span style={{ visibility: 'hidden' }} className="rounded-[5px] inline-block align-middle pt-[6px] pr-1 pb-1 pl-[6px] text-sm mr-[5px] mb-[1px] bg-[#e02020] border-solid border-[#e02020] border-[1px] text-[#fff]">
                        ZORUNLU
                      </span>
                      <div className="w-fit">
                        <span className="flex">
                          ...
                          <span onMouseEnter={() => setTooltipStatus(3)} onMouseLeave={() => setTooltipStatus(0)} role="img" aria-label="question-circle" id="info-text-question"
                            ...
                            {tooltipStatus === 3 && (
                              <div role="tooltip" className="text-black bg-slate-300 m-0 p-0 list-none absolute z-[1070] w-max max-w-[250px] visible" style={{ left: "600px", top: 35, boxSizing: "border-box", transformOrigin: "-12px 50%", pointerEvents: "none" }}>
                                ...
                                <div className="w-max relative">
                                  <div className="!pt-3 !px-3 !pb-1 rounded-md bg-white text-black whitespace-normal !text-center text-sm font-normal min-w-8 min-h-8 no-underline break-words" style={{ boxShadow: '0 6px 16px 0 rgba(0, 0, 0, 0.08), 0 3px 6px -4px rgba(0, 0, 0, 0.12), 0 9px 28px 8px rgba(0, 0, 0, 0.05)' }} role="tooltip">
              ...
              <div className="!px-2 ">
                <div className="text-right w-full sm:w-full md:w-full">
                  <div className="text-left box-border m-0 p-0 text-slate-900 list-none inline-block relative w-full text-sm me-2 mb-2" role="progressbar">
                    ...
                    <span className="text-[#565656] inline-block w-[2em] ms-2 leading-none whitespace-nowrap text-start align-middle break-normal" title="2%">
                      2%
                    </span>
                  </div>
