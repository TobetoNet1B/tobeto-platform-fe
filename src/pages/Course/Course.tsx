  ...
  return (
    <div className="mt-5">
      <div className="!overflow-visible box-border m-0 p-0 text-[#1a1a1a] text-sm list-none flex flex-col" style={{ overflow: "unset" }}>
        <div role="tablist" className="relative flex flex-none items-center mx-0 mt-0 mb-4 before:bottom-0 before:absolute before:right-0 before:left-0 before:border before:border-solid before:border-[#f0f0f0] before:content-['']">
          <div className="relative flex flex-auto self-stretch overflow-hidden whitespace-nowrap transform translate-x-0 translate-y-0 before:absolute before:z-[1] before:opacity-0 before:transition-opacity before:duration-[300ms] before:content-[''] before:pointer-events-none before:left-0 before:shadow-[10px_0_8px_-8px_rgba(0, 0, 0, 0.08)] before:top-0 before:bottom-0 before:w-8 after:absolute after:z-[1] after:opacity-0 after:transition-opacity after:duration-[300ms] after:content-[''] after:pointer-events-none after:right-0 after:shadow-[10px_0_8px_-8px_rgba(0, 0, 0, 0.08)] after:top-0 after:bottom-0 after:w-8">
            <div className="relative flex transition-opacity duration-[300ms]" style={{ transform: "translate(0px, 0px)" }}>
              <div onClick={() => handleButtonClick(0)} data-node-key="content" className="relative inline-flex items-center py-3 px-0 text-sm bg-transparent border-0 outline-none cursor-pointer  text-black">
                <div role="tab" aria-selected="true" className={`transition-none font-medium outline-none ${showFirst === 0 ? "text-black" : "text-[#7f7f7f]"}`} tabIndex={0} id="rc-tabs-0-tab-content" aria-controls="rc-tabs-0-panel-content">
                  <div className="relative cursor-pointer">
                    <span className="text-lg">İçerik</span>
                  </div>
                </div>
              </div>
              <div onClick={() => handleButtonClick(1)} data-node-key="about" className="text-[#7f7f7f] my-0 mr-0 ml-8 relative inline-flex items-center py-3 px-0 text-sm bg-transparent border-0 outline-none cursor-pointer">
                <div role="tab" aria-selected="false" className={` transition-none font-medium outline-none ${showFirst === 1 ? "text-black" : "text-[#7f7f7f]"}`} tabIndex={0} id="rc-tabs-0-tab-about" aria-controls="rc-tabs-0-panel-about">
                  <div className="relative cursor-pointer">
